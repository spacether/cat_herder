...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__level_js__ = __webpack_require__(3);
...
class Game {
  constructor() {
    this.level = new __WEBPACK_IMPORTED_MODULE_0__level_js__["a" /* default */]({x: 0, y: 0, width: 800, height: 400, playAudio: this.playAudio.bind(this), isPaused: this.isPaused.bind(this), win: this.win.bind(this)});
    this.muted = false;
    this.paused = true;
  }
  render(){
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__cat_js__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__player_js__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__vector_js__ = __webpack_require__(1);
...
class Level {
  constructor({x, y, width, height, playAudio, isPaused, win}){
    ...
    this.trappedCats = [];
    let corral = new __WEBPACK_IMPORTED_MODULE_0__shapes_js__["a" /* TiltedRect */](0, 0, 100, 100, 'brown', 0);
    this.corral = corral;
    ...
    // Make the cats
    this.cats = this.createCats(4, playAudio);
  ...
  createCats(num, playAudio){
    ...
    for(let i=0; i<4; i++){
      ...
      while (hit){
        ...
        cat = new __WEBPACK_IMPORTED_MODULE_1__cat_js__["a" /* default */](loc.x, loc.y, 17, 17*2.5, this.sounds['CAT_MEW'], this.sounds['CAT_ANGRY'], playAudio);
        hit = false;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__vector_js__ = __webpack_require__(1);
...
class Cat {
  ...
  makeShapes(){
    ...
    let rel = new __WEBPACK_IMPORTED_MODULE_2__vector_js__["a" /* default */](length*0.5 - headDiam, 0).rotate(angleRad);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__shapes_js__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__vector_js__ = __webpack_require__(1);
